...
docker run -cidfile built_cid -i -v $(readlink -m ../../test_repos/rackup):/tmp/repo:ro smarterclayton/centos-ruby2 /opt/openshift/start /opt/openshift/prepare /tmp/repo
